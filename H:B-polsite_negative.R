...
############################## RES 1 ##############################
res1_abierta <- read.csv("6nt6_NO_BORRAR/hbonds/part1/hbonds_res1.csv")
res1_holo <- read.csv("6nt7_HOLO_NO_BORRAR/hbonds/part1/hbonds_res1.csv")
...
residues2_holo <- c("275", "276", "280", "290", "291", "354", "473", "486", "487", "488", "518")
...
residues2_abierta <- c("157", "275", "276", "290", "291", "473", "486", "487", "488", "518")
...
residues3_holo <- c("150", "272", "294", "491")
...
residues3_abierta <- c("272", "294", "347", "491")
...
residues6_abierta <- c("440", "265", "465")
...
residues7_abierta <- c("168", "432", "468")
